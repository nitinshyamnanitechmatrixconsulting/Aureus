...
private var token =""
    suspend fun newInstance(identity: String, roomName: String,localDataTrack: LocalDataTrack?): ConnectOptions {

        setSdkEnvironment(sharedPreferences)
        try {
            val tokenResponse = tokenService.getToken(identity, roomName)
