...
abstract class ParticipantView extends FrameLayout implements VideoSink {
    ...
    TextView videoIdentity, tvShortName;
    VideoTextureView videoView;
    RelativeLayout selectedLayout, rlThumbView;
    // ImageView stubImage;
    @Nullable
    ...
    public void setIdentity(String identity) {
        ...
        tvShortName.setText(StringHelper.Companion.getShortString(identity));
    ...
    public void setState(int state) {
        ...
        switch (state) {
            ...
            case State.SELECTED:
                ...
                // rlThumbView.setVisibility(VISIBLE);
                tvShortName.setVisibility(VISIBLE);
...
/*
    public void setTvShortName(String shortName) {
        tvShortName.setText(StringHelper.Companion.getShortString(shortName));
    }
*/
    ...
    private void videoState() {
        ...
        // rlThumbView.setVisibility(GONE);
        tvShortName.setVisibility(GONE);
    ...
    public void setMuted(boolean muted) {
        if (audioToggle != null) {
            if (muted) {
                audioToggle.setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.ic_mic_off_gray_24px));
            } else {
                audioToggle.setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.active_participant_speaking));
            }
        }
    ...
    public void setPinned(boolean pinned) {
        if (pinImage != null) pinImage.setVisibility(pinned ? VISIBLE : INVISIBLE);
    }
