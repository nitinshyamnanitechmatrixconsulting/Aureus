...
class TicketOpenFragment : BaseFragment() {
    ...
    companion object {
        val TAG = TicketOpenFragment::class.simpleName
        fun newInstance(): TicketOpenFragment {
            return TicketOpenFragment()
        }
    }
    ...
    private fun hitTicketApi() {
        if (Connectivity.isConnected(activity)) {
            var request =
                TicketRequest(preferenceHelper[PreferenceHelper.PARENR_ID], "Upcoming", 10, 0)
