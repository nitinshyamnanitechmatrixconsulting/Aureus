...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if(attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs,R.styleable.wheelview1,0,0);
            mGravity = a.getInt(R.styleable.wheelview1_gravity, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.wheelview1_textColorOut, textColorOut);
            textColorCenter = a.getColor(R.styleable.wheelview1_textColorCenter,textColorCenter);
            dividerColor = a.getColor(R.styleable.wheelview1_dividerColor,dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.wheelview1_textSize1,textSize);
        }
